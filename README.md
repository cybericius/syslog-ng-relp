...
syslog-ng OSE [does not have built-in RELP support](https://github.com/syslog-ng/syslog-ng/issues/4312). The commercial syslog-ng PE includes ALTP (a proprietary reliable transport), but OSE has no equivalent — leaving a gap when you need reliable log delivery to or from rsyslog and other RELP-speaking systems.
